...
import com.yunqi.cloudenglish.generate.model.UserExample.Criteria;
import com.yunqi.cloudenglish.generate.model.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getIdentity() != null) {
            sql.SET("identity = #{record.identity,jdbcType=VARCHAR}");
        }
